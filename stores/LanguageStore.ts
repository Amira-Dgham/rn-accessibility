...
export const LanguageStore = types
    .model('LanguageStore', {
        ...
        availableLanguages: types.optional(
            types.array(LanguageOption),
            AVAILABLE_LANGUAGES
        ),
    })
    .views((self) => ({
        ...
        translate(key: TranslationNestedKey | string, params?: Record<string, string | number>): string {
        ...
        return {
            ...
            initialize: flow(function* () {
                try {
                    ...
                    const savedLanguage = storageService.getString(STORAGE_KEYS.LANGUAGE) as SupportedLanguage;
                    ...
                    if (savedLanguage && isValidLanguageCode(savedLanguage, self.availableLanguages)) {
                        ...
                        const preferredLanguage = getPreferredSupportedLanguage(deviceLanguages, self.availableLanguages);
