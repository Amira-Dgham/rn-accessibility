export const fr = {
  ...
  accessibility: {
    ...
    components: {
      ...
      sliders: {
        title: 'Curseurs',
        description: 'Les curseurs accessibles permettent aux utilisateurs d\'ajuster des valeurs dans une plage en utilisant diverses méthodes de saisie.',
        requirements: {
          A: {
      ...
      textInputs: {
        ...
        description: 'Les champs de texte accessibles fournissent un étiquetage clair et un support pour diverses méthodes de saisie.',
        requirements: {
          A: {
      ...
      tabs: {
        title: 'Onglets',
        description: 'Les onglets accessibles organisent le contenu en sections logiques navigables par tous les utilisateurs.',
        requirements: {
          A: {
      ...
      sheets: {
        title: 'Feuilles',
        description: 'Les feuilles accessibles fournissent du contenu modal qui est correctement contenu et navigable.',
        requirements: {
          A: {
      ...
      webview: {
        title: 'WebView',
        description: 'Les WebViews accessibles fournissent l\'accès au contenu web dans le contexte de l\'application.',
        requirements: {
          A: {
      ...
      video: {
        title: 'Vidéo',
        description: 'Les vidéos accessibles fournissent des sous-titres, descriptions et contrôles pour tous les utilisateurs.',
        requirements: {
          A: {
