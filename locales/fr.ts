export const fr = {
  ...
  accessibility: {
    ...
    components: {
      ...
      alerts: {
        title: 'Alertes',
        description: "Les alertes accessibles informent les utilisateurs d'informations importantes ou de changements d'état.",
        requirements: {
          A: {
      ...
      buttons: {
        title: 'Boutons',
        description: 'Les boutons accessibles sont utilisables par tous et fournissent un retour clair.',
        requirements: {
          A: {
      ...
      cards: {
        title: 'Cartes',
        description: 'Les cartes accessibles regroupent des informations liées et sont navigables par les technologies d\'assistance.',
        requirements: {
          A: {
      ...
      charts: {
        title: 'Graphiques',
        description: 'Les graphiques accessibles fournissent une visualisation de données perceptible par tous les utilisateurs.',
        requirements: {
          A: {
      ...
      checkboxes: {
        ...
        description: 'Les cases à cocher accessibles sont utilisables, clairement étiquetées et indiquent leur état.',
        requirements: {
          A: {
      ...
      confirmationDialog: {
        ...
        description: 'Les dialogues de confirmation accessibles fournissent des choix clairs et préviennent les actions accidentelles.',
        requirements: {
          A: {
      ...
      dataTable: {
        ...
        description: 'Les tableaux de données accessibles fournissent des informations structurées navigables et compréhensibles par tous les utilisateurs.',
        requirements: {
          A: {
      ...
      dateTimePicker: {
        ...
        description: 'Les sélecteurs de date et heure accessibles permettent aux utilisateurs de sélectionner des dates et heures via diverses méthodes de saisie.',
        requirements: {
          A: {
      ...
      errorValidation: {
        ...
        description: 'La validation d\'erreur accessible fournit un retour clair et des conseils pour corriger les erreurs de saisie.',
        requirements: {
          A: {
      ...
      focusManagement: {
        ...
        description: 'Une gestion appropriée du focus assure une navigation logique et prévient les pièges de focus.',
        requirements: {
          A: {
      ...
      images: {
        title: 'Images',
        description: 'Les images accessibles fournissent des alternatives significatives pour les utilisateurs qui ne peuvent pas voir le contenu visuel.',
        requirements: {
          A: {
      ...
      links: {
        title: 'Liens',
        description: 'Les liens accessibles sont clairement identifiables et fournissent des informations significatives sur leur destination.',
        requirements: {
          A: {
      ...
      lists: {
        title: 'Listes',
        description: 'Les listes accessibles organisent l\'information de manière structurée navigable par les technologies d\'assistance.',
        requirements: {
          A: {
      ...
      menu: {
        title: 'Menu',
        description: 'Les menus accessibles fournissent des options de navigation utilisables par tous les utilisateurs.',
        requirements: {
          A: {
      ...
      progressIndicators: {
        ...
        description: 'Les indicateurs de progression accessibles fournissent un retour sur les processus et opérations en cours.',
        requirements: {
          A: {
      ...
      radioButton: {
        title: 'Boutons radio',
        description: 'Les boutons radio accessibles permettent aux utilisateurs de sélectionner une option d\'un groupe mutuellement exclusif.',
        requirements: {
          A: {
      ...
      segmentedControl: {
        ...
        description: 'Les contrôles segmentés accessibles permettent aux utilisateurs de basculer entre des options ou vues liées.',
        requirements: {
          A: {
      ...
      sliders: {
        title: 'Curseurs',
        description: 'Les curseurs accessibles permettent aux utilisateurs de sélectionner des valeurs dans une plage.',
        requirements: {
          A: {
            '1': 'Le curseur est utilisable au clavier',
            '2': 'Le curseur a des étiquettes et instructions claires',
          },
          AA: {
            '1': 'La valeur du curseur est déterminable par programme',
            '2': 'Le curseur offre un contraste de couleurs suffisant',
          },
          AAA: {
            '1': 'Le curseur prend en charge les états personnalisés et les attributs ARIA',
            '2': 'Le curseur fournit un contexte de valeur détaillé pour les lecteurs d\'écran',
          },
        },
      },
      switches: {
        title: 'Interrupteurs',
        description: 'Les interrupteurs accessibles permettent aux utilisateurs de basculer entre deux états.',
        requirements: {
          A: {
      ...
      textInput: {
        ...
        description: 'Les saisies de texte accessibles fournissent des étiquettes claires et un retour de validation.',
        requirements: {
          A: {
            '1': 'La saisie a une étiquette descriptive',
            '2': 'La saisie est utilisable au clavier',
          },
          AA: {
            '1': 'La saisie offre un contraste de couleurs suffisant',
            '2': 'La saisie annonce les changements d\'état aux lecteurs d\'écran',
          },
          AAA: {
            '1': 'La saisie prend en charge l\'autocomplétion et les suggestions',
            '2': 'La saisie fournit des instructions détaillées et de l\'aide',
          },
        },
      },
      tabs: {
        title: 'Onglets',
        description: 'Les onglets accessibles organisent le contenu en sections logiques avec une navigation appropriée.',
        requirements: {
          A: {
            '1': 'Les onglets sont utilisables au clavier',
            '2': 'Les onglets ont des étiquettes descriptives',
          },
          AA: {
            '1': 'L\'onglet actif est clairement indiqué',
            '2': 'Les onglets offrent un contraste de couleurs suffisant',
          },
          AAA: {
            '1': 'Les onglets prennent en charge les états personnalisés et les attributs ARIA',
            '2': 'Les onglets fournissent un contexte détaillé pour les lecteurs d\'écran',
          },
        },
      },
      deviceOrientation: {
        title: 'Orientation de l\'Appareil',
        description: 'Support pour différentes orientations d\'appareil avec des considérations d\'accessibilité.',
        requirements: {
          A: {
      ...
      groupingControls: {
        ...
        description: 'Les contrôles de groupement accessibles organisent les éléments d\'interface liés pour une meilleure navigation et compréhension.',
        requirements: {
          A: {
      ...
      headingLevel: {
        ...
        description: 'Hiérarchie appropriée des titres pour la structure et la navigation du document.',
        requirements: {
          A: {
      ...
      largeContentViewer: {
        ...
        description: 'Visualiseur accessible pour les zones de contenu larges avec une navigation appropriée.',
        requirements: {
          A: {
      ...
      pickers: {
        title: 'Sélecteurs',
        description: 'Les sélecteurs accessibles permettent aux utilisateurs de sélectionner parmi des options en utilisant diverses méthodes de saisie.',
        requirements: {
          A: {
      ...
      sheets: {
        title: 'Feuilles',
        description: 'Feuilles de fond accessibles avec une gestion appropriée du focus et de la navigation.',
        requirements: {
          A: {
            '1': 'Les feuilles sont utilisables au clavier',
            '2': 'Les feuilles ont des étiquettes descriptives',
          },
          AA: {
            '1': 'Les feuilles offrent un contraste de couleurs suffisant',
            '2': 'Les feuilles annoncent les changements d\'état aux lecteurs d\'écran',
          },
          AAA: {
            '1': 'Les feuilles prennent en charge les états personnalisés et les attributs ARIA',
            '2': 'Les feuilles fournissent un contexte détaillé pour les lecteurs d\'écran',
          },
        },
      },
      webview: {
        title: 'WebView',
        description: 'Composants web view accessibles avec une navigation et un support de contenu appropriés.',
        requirements: {
          A: {
            '1': 'Le contenu WebView est navigable au clavier',
            '2': 'WebView a des étiquettes descriptives',
          },
          AA: {
            '1': 'WebView offre un contraste de couleurs suffisant',
            '2': 'WebView prend en charge le zoom et le défilement',
          },
          AAA: {
            '1': 'WebView prend en charge les modèles de navigation personnalisés',
            '2': 'WebView fournit un contexte détaillé pour les lecteurs d\'écran',
          },
        },
      },
      video: {
        title: 'Vidéo',
        description: 'Composants vidéo accessibles avec sous-titres et descriptions audio.',
        requirements: {
          A: {
            '1': 'Les vidéos ont des sous-titres ou des transcriptions',
            '2': 'Les vidéos ont des étiquettes descriptives',
          },
          AA: {
            '1': 'Les vidéos offrent un contraste de couleurs suffisant',
            '2': 'Les vidéos prennent en charge les contrôles au clavier',
          },
          AAA: {
            '1': 'Les vidéos prennent en charge les descriptions audio',
            '2': 'Les vidéos fournissent un contexte détaillé pour les lecteurs d\'écran',
          },
        },
      },
      reduceMotion: {
        title: 'Réduire le mouvement',
        description: 'Les contrôles de mouvement accessibles permettent aux utilisateurs de personnaliser les préférences d\'animation et de mouvement.',
        requirements: {
          A: {
      ...
      timeLimits: {
        ...
        description: 'Les limites de temps accessibles fournissent aux utilisateurs un contrôle sur le contenu et les fonctionnalités sensibles au temps.',
        requirements: {
          A: {
      ...
      gesturesAlternatives: {
        ...
        description: 'Les alternatives aux gestes accessibles fournissent plusieurs méthodes de saisie pour les utilisateurs qui ne peuvent pas utiliser les gestes tactiles.',
        requirements: {
          A: {
      ...
      language: {
        title: 'Langue',
        description: 'Le support de langue accessible garantit que le contenu est compréhensible pour les utilisateurs ayant différents besoins linguistiques.',
        requirements: {
          A: {
      ...
      comprehension: {
        title: 'Compréhension',
        description: 'Support pour les utilisateurs ayant des difficultés de compréhension et des troubles d\'apprentissage.',
        requirements: {
          A: {
